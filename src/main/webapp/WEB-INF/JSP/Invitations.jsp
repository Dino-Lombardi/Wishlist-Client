...
<%
    ArrayList<Invitation> invitations = (ArrayList<Invitation>) request.getAttribute("invitations");
            ...
            <td>
                <% if (showButtons) { %>
                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        <form action="<%= request.getContextPath() %>/home/UpdateInvitation" method="post" style="display:inline;">
